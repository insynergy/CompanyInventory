...
<div id="section">
<h2>${message}</h2>
<c:url var="scarchAction" value="/doScarch/inventory" ></c:url>
<form action="${scarchAction}" commandName="inventory" method="post">
     
   Search  &nbsp;<input type="text" name="searchItem" /><br/><br/>
