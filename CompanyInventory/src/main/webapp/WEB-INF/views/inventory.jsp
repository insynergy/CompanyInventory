...
<div id="header">
  ...
  Add Inventory <div style='float:right'><input type="submit" value="Logout"/></div>
    </form>
...
<table>
	...
	<tr>
		...
		<td class = 'kr'><form:errors path="count" cssClass="error" /></td>
	</tr>
